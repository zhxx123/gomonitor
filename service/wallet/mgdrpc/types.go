...
func WithMGDHttpClient(client *http.Client) func(rpc *MgdRPC) {
	return func(rpc *MgdRPC) {
		rpc.client = client
	}
}

// WithLogger set custom logger
func WithMGDLogger(l logger) func(rpc *MgdRPC) {
	return func(rpc *MgdRPC) {
		rpc.log = l
	}
}
...
func WithMGDDebug(enabled bool) func(rpc *MgdRPC) {
	return func(rpc *MgdRPC) {
		rpc.Debug = enabled
	}
}
